    ...
    */
    ...
    {  
		...
		'goodsListDetails' => $this->goodsTransactionService->getStaffGoodsDetails($id),		
	   	'checkDepreciation' => $this->goodsTransactionService->getStaffDepreciationDetails($id),
	    ));
        }else{
    ...
    public function empGoodsListAction()
    {
	    ...
	    'goodSurrenderedStatus' => $this->goodsTransactionService->goodSurrenderedStatus($this->employee_details_id),
	    'keyphrase' => $this->keyphrase,
            'message' => $message,
            ));
    }
