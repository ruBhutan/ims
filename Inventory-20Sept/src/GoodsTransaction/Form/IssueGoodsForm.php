...
class IssueGoodsForm extends Form
 {
        ...
        $this->add(array(
           'name' => 'item_sub_category_id',
            'type'=> 'Select',
             ...
             'attributes' => array(
                  'class' => 'form-control ',
                  'id' => 'selectAdhocGoodsIssueSubCategory',
                  'options' => $this->createAdhocGoodsIssueSubCategoryType(),
                  'required' => 'required',
             ),
         ));
        ...
        $this->add(array(
           'name' => 'item_name_id',
            'type'=> 'Select',
             ...
             'attributes' => array(
                  'class' => 'form-control ',
                  'id' => 'selectAdhocGoodsIssueItemName',
                  'options' => array(),
                  'required' => 'required',
             ),
         ));
           ...
           'name' => 'goods_received_id',
            'type'=> 'Select',
             ...
             'attributes' => array(
                  ...
                  'class' => 'form-control ',
                  'rows' => 20,
                  'id' => 'selectAdhocGoodsIssueItemDetails',
                  'readonly' => 'readonly',
                  'options' => array(),
                  'required' => 'required',
             ),
