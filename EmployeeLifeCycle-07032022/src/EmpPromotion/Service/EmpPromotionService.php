...
class EmpPromotionService implements EmpPromotionServiceInterface
{
	...
	*/
	...
	{
		return $this->promotionMapper->save($promotionObject, $performance_year_data, $performance_rating_data, $performance_category_data, $userrole);
	}
	...
	{
		return $this->promotionMapper->getPromotionDetails($id);
	}

	public function getEmployeePromotionId($id, $promotion_type)
	{
		return $this->promotionMapper->getEmployeePromotionId($id, $promotion_type);
	}
	...
	{
		return $this->promotionMapper->getPromotionDetailFileName($emp_promotion_id, $column_name);
	}
	...
	{
		return $this->promotionMapper->getPromotionApplicant($employee_details_id);
	}
	...
	{
		return $this->promotionMapper->findEmployeeExtraDetails($tableName, $id);
	}
