...
class EmpTrainingFieldset extends Fieldset implements InputFilterProviderInterface
{

	public function __construct()
     {
         // we want to ignore the name passed
        parent::__construct('employeetraining');
      ...
      $this->add(array(
           'name' => 'course_level',
            'type'=> 'select',
             'options' => array(
                 'empty_option' => 'Please Select Course Level',
         'disable_inarray_validator' => true,
         'class'=>'control-label',
             ),
             'attributes' => array(
