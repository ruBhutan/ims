	...
	'router' => array(
 		'routes' => array(
			...
			'editunit' => array(
			 ...
			 'addorganisationimage' => array(
				'type' => 'segment',
				'options' => array(
				'route' => '/addorganisationimage[/:action][/:id]',
				'constraints' => array(
					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					'id' => '[a-zA-Z0-9_-]*',
					),
			   'defaults' => array(
				   'controller' => 'OrgSettings',
				   'action' => 'addOrganisationImage',
					),
				),
			),
			'insertorganisationdocument' => array(
				'type' => 'segment',
				'options' => array(
				'route' => '/insertorganisationdocument[/:action][/:id]',
				'constraints' => array(
					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					'id' => '[a-zA-Z0-9_-]*',
					),
			   'defaults' => array(
				   'controller' => 'OrgSettings',
				   'action' => 'insertOrganisationDocument',
					),
				),
			),  
 		),
