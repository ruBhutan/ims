...
class Organisation
{
	...
	protected $organisation_dzongkha_name;
	protected $address;
	...
	public function getOrganisation_Dzongkha_Name()
	{
		return $this->organisation_dzongkha_name;
	}
	
	public function setOrganisation_Dzongkha_Name($organisation_dzongkha_name)
	{
		$this->organisation_dzongkha_name = $organisation_dzongkha_name;
	}
	...
	public function getOrganisation_Code()
	{
		return $this->organisation_code;
	}
	
	public function setOrganisation_Code($organisation_code)
	{
