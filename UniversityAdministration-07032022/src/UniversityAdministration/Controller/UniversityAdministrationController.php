...
//To add Student Type Action
    ...
    { 
        ...
        $categories = $this->universityAdministrationService->listAll($tableName='meeting_type', $this->organisation_id, $this->employee_details_id, 0);
    ...
    public function departmentFilingInformationAction()
    {
        $this->loginDetails();
        //get the id
        ...
        $selectData = $this->universityAdministrationService->listAll($tableName='meeting_minutes', $this->organisation_id, $id, 0);
    ...
    public function rubmeetingMinuteInformationAction()
    {
        ...
        $selectData = $this->universityAdministrationService->listAll($tableName='meeting_minutes', 0, $id, 0);
    ...
    public function newspaperInformationAction()
    {
        ...
        $selectData = $this->universityAdministrationService->listAll($tableName, $columnName, $id, 0);
