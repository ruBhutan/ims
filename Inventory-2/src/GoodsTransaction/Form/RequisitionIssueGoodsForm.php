...
class RequisitionIssueGoodsForm extends Form
 {
    protected $serviceLocator;
         ...
         $this->add(array(
           'name' => 'departments_id',
            'type'=> 'Select',
             ...
             'attributes' => array(
                  'class' => 'form-control ',
                  'id' => 'selectRequisitionDepartmentName',
                  'options' => $this->createRequisitionDepartmentTypeList(),
                  'required' => 'required',
             ),
         ));
        ...
        $this->add(array(
           'name' => 'employee_details_id',
            'type'=> 'Select',
             ...
             'attributes' => array(
                  'class' => 'form-control ',
                  'id' => 'selectRequisitionDepartmentStaff',
                  'options' => array(),
                  'required' => 'required',
             ),
         ));
           ...
           'name' => 'goods_received_id',
            'type'=> 'Select',
             ...
             'attributes' => array(
                  ...
                  'class' => 'form-control ',
                  'rows' => 20,
                  'id' => 'selecRequisitionItemInStock',
                  //'readonly' => 'readonly',
                  'options' => array(),
                  'required' => 'required',
             ),
     ...
     private function createRequisitionDepartmentTypeList()
    {
