...
class GoodsReceivedPurchasedForm extends Form
 {
    private $serviceLocator;
     ...
     public function __construct($serviceLocator = null, array $options = [])
     {
        ...
        $this->add(array(
             'type' => 'GoodsTransaction\Form\GoodsReceivedPurchasedFieldset',
             'options' => array(
        ...
        $this->add(array(
           'name' => 'item_category_id',
            'type'=> 'Select',
             ...
             'attributes' => array(
                  'class' => 'form-control ',
                  'id' => 'selectGoodsReceivedPurchasedCategory',
                  'options' => $this->createPurchasedItemCategoryType(),
                  'required' => 'required'
             ),
         ));
        ...
        $this->add(array(
           'name' => 'item_sub_category_id',
            'type'=> 'Select',
             ...
             'attributes' => array(
                  'class' => 'form-control ',
                  'id' => 'selectGoodsReceivedPurchasedSubCategory',
                  'options' => array(),
                  'required' => 'required'
             ),
         ));
        ...
        $this->add(array(
           'name' => 'item_name_id',
            'type'=> 'Select',
             ...
             'attributes' => array(
                  'class' => 'form-control ',
                  'id' => 'selectGoodsReceivedPurchasedItemName',
                  'options' => array(),
                  'required' => 'required'
             ),
         ));
     ...
     private function createPurchasedItemCategoryType()
    {
