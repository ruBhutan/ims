...
class StudentSuggestionsController extends AbstractActionController
{
	...
	public function viewStudentSuggestionAction()
    {
		...
		//$studentSuggestions = $this->studentService->listAll($tableName = 'student_suggestion');
		//$suggestionCategory = $this->studentService->listAll($tableName = 'student_suggestion_category');
