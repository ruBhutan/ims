...
class BudgetTable extends AbstractTableGateway implements AdapterAwareInterface
{
	protected $table = 'accounts_budget'; //tablename
	...
	{  
	    ...
	    $select = $sql->select();
	   	$select->from(array('b'=>$this->table))
				->join(array('o'=>'organisation'), 'o.id= b.organisation_id', array('organisation'=>'organisation_name','organisation_id'=>'id'));	    
