...
class TransactiondetailTable extends AbstractTableGateway implements AdapterAwareInterface
{
   ...
   /**
	 ...
	 * @return Int
	 */
	public function getOpeningBalanceforBA($organisation,$end_date, $subhead_id)
	{		
		$adapter = $this->adapter;  
		$sql = new Sql($adapter);
		...
		$sub0 = new Select("accounts_closing_balance");
			...
			$total_debit = $this->getSumbySubheadforBA($organisation,$end_date, 'debit', $subhead_id);
			$total_credit = $this->getSumbySubheadforBA($organisation,$end_date, 'credit', $subhead_id); 			 
