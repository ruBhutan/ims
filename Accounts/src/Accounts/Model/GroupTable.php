...
class GroupTable extends AbstractTableGateway implements AdapterAwareInterface
{
	protected $table = 'accounts_group'; //tablename
...
/**
	...
	*/
	 ...
	 * 
	 **/
	public function getTransactionGroupforPLS($organisation,$start_date,$end_date, $where)
	{
