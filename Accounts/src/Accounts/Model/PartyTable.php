...
class PartyTable extends AbstractTableGateway implements AdapterAwareInterface
{
	protected $table = 'supplier_details'; //tablename
	...
	{  
	    ...
	    $select->from(array('p'=>$this->table))
				...
				->join(array('r'=>'accounts_party_role'),'r.id = p.id', array('party_role'=>'party_role','party_role_id' => 'id'));
