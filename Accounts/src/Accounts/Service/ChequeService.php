...
use Accounts\Mapper\ChequeMapperInterface;

class ChequeService implements ChequeServiceInterface {

    protected $mapper;

    public function __construct(ChequeMapperInterface $mapper) {
        $this->mapper = $mapper;
    }
