...
/**
    ...
    **/
    ...
    public function updateStudentChangeProgramme($programme_data, $stdProgramme, $stdYear, $stdName, $stdId, $organisation_id, $changeProgramme, $year, $semester, $academicYear, $updateDate, $updateBy)
    {
        $i = 1;
        $studentIds = array();
        ...
        if($programme_data != NULL)
        {
            ...
            foreach($programme_data as $data){
                ...
                if($data == '1')
                {
                    ...
                    $this->updateStudentProgrammeSemester($studentIds[$i], $changeProgramme, $year, $semester, $academicYear, $updateDate);
                }
    ...
    public function updateStudentProgrammeSemester($student_id, $changeProgramme, $year, $semester, $academicYear, $updateDate)
    {
        ...
        $action = new Update('student_semester_registration');
        $action->set(array('year_id' => $year, 'semester_id'  => $semester, 'academic_session_id' => $academic_session_id, 'student_section_id' => '1', 'enrollment_year' => $enrollment_year, 'academic_year' => $academicYear, 'updated_date' => $updateDate));
        $action->where(array('student_id = ?' => $student_id));
