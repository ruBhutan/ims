	...
	'router' => array(
 		'routes' => array(
			...
			'editbudgetproposal' => array(
 				'type' => 'segment',
 				'options' => array(
					'route' => '/editbudgetproposal[/:action][/:id][/:role_type]',
					'constraints' => array(
						'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
						'id' => '[a-zA-Z0-9_-]*',
						'role_type' => '[a-zA-Z0-9_-]*',
						),
					'defaults' => array(
						'controller' => 'CurrentBudget',
						'action' => 'editCurrentBudgetProposal',
						),
 				),
 			),
 			'deletecurrentbudgetproposal' => array(
 				'type' => 'segment',
 				'options' => array(
					'route' => '/deletecurrentbudgetproposal[/:action][/:id]',
					'constraints' => array(
						'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
						'id' => '[a-zA-Z0-9_-]*',
						),
					'defaults' => array(
						'controller' => 'CurrentBudget',
						'action' => 'deleteCurrentBudgetProposal',
						),
 				),
 			),
			...
			'editcapitalbudgetproposal' => array(
 				'type' => 'segment',
 				'options' => array(
					'route' => '/editcapitalbudgetproposal[/:action][/:id][/:role_type]',
					'constraints' => array(
						'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
						'id' => '[a-zA-Z0-9_-]*',
						'role_type' => '[a-zA-Z0-9_-]*',
			...
			'budgetreappropriation' => array(
			 ...
			 'vieworgcurrentbudgetreappropriation' => array(
				'type' => 'segment',
				'options' => array(
				   'route' => '/vieworgcurrentbudgetreappropriation[/:action][/:id]',
				   'constraints' => array(
					   'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					   'id' => '[a-zA-Z0-9_-]*',
					   ),
				   'defaults' => array(
					   'controller' => 'CurrentBudget',
					   'action' => 'viewOrgCurrentBudgetReappropriation',
					   ),
				),
			),
			'viewbudgetreappropriationdetail' => array(
				'type' => 'segment',
				'options' => array(
				   'route' => '/viewbudgetreappropriationdetail[/:action][/:id]',
				   'constraints' => array(
					   'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					   'id' => '[a-zA-Z0-9_-]*',
					   ),
				   'defaults' => array(
					   'controller' => 'CurrentBudget',
					   'action' => 'viewBudgetReappropriationDetail',
					   ),
				),
			),
			...
			'capitalbudgetreappropriation' => array(
			 ...
			 'vieworgcapitalbudgetreappropriation' => array(
				'type' => 'segment',
				'options' => array(
				   'route' => '/vieworgcapitalbudgetreappropriation[/:action][/:id]',
				   'constraints' => array(
					   'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					   'id' => '[a-zA-Z0-9_-]*',
					   ),
				   'defaults' => array(
					   'controller' => 'CapitalBudget',
					   'action' => 'viewOrgCapitalBudgetReappropriation',
					   ),
				),
			),
			'viewcapitalbudgetreappropriationdetail' => array(
				'type' => 'segment',
				'options' => array(
				   'route' => '/viewcapitalbudgetreappropriationdetail[/:action][/:id]',
				   'constraints' => array(
					   'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					   'id' => '[a-zA-Z0-9_-]*',
					   ),
				   'defaults' => array(
					   'controller' => 'CapitalBudget',
					   'action' => 'viewCapitalBudgetReappropriationDetail',
					   ),
				),
			),
			...
			'editcapitalbudgetreappropriation' => array(
			 ...
			 'updatebudgetreappropriationproposal' => array(
				'type' => 'segment',
				'options' => array(
					'route' => '/updatebudgetreappropriationproposal[/:action][/:id][/:status][/:type]',
					'constraints' => array(
						'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
						'id' => '[a-zA-Z0-9_-]*',
						'status' => '[a-zA-Z0-9_-]*',
				   ...
				   'defaults' => array(
					   'controller' => 'CapitalBudget',
					   'action' => 'updateBudgetReappropriationProposal',
					   ),
				),
			),
			...
			'viewcurrentsupplementarybudget' => array(
			 ...
			 'listorgcurrentsupplementarybudget' => array(
				'type' => 'segment',
				'options' => array(
				   'route' => '/listorgcurrentsupplementarybudget[/:action][/:id]',
				   'constraints' => array(
					   'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					   'id' => '[a-zA-Z0-9_-]*',
					   ),
				   'defaults' => array(
					   'controller' => 'BudgetTransactions',
					   'action' => 'listOrgCurrentSupplementaryBudget',
					   ),
				),
			),
			...
			'capitalsupplementarybudget' => array(
			 ...
			 'listorgcapitalsupplementarybudget' => array(
				'type' => 'segment',
				'options' => array(
				   'route' => '/listorgcapitalsupplementarybudget[/:action][/:id]',
				   'constraints' => array(
					   'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					   'id' => '[a-zA-Z0-9_-]*',
					   ),
				   'defaults' => array(
					   'controller' => 'BudgetTransactions',
					   'action' => 'listOrgCapitalSupplementaryBudget',
					   ),
				),
			),
			...
			'editcapitalsupplementarybudget' => array(
			 ...
			 'updatesupplementarybudgetproposal' => array(
				'type' => 'segment',
				'options' => array(
				   'route' => '/updatesupplementarybudgetproposal[/:action][/:id][/:status][/:type]',
				   'constraints' => array(
					   'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					   'id' => '[a-zA-Z0-9_-]*',
					   'status' => '[a-zA-Z0-9_-]*',
				   ...
				   'defaults' => array(
					   'controller' => 'BudgetTransactions',
					   'action' => 'updateSupplementaryBudgetProposal',
					   ),
				),
			),
			...
			'currentbudgetwithdrawal' => array(
			 ...
			 'listorgcurrentbudgetwithdrawal' => array(
				'type' => 'segment',
				'options' => array(
				   'route' => '/listorgcurrentbudgetwithdrawal[/:action][/:id]',
				   'constraints' => array(
					   'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					   'id' => '[a-zA-Z0-9_-]*',
					   ),
				   'defaults' => array(
					   'controller' => 'BudgetTransactions',
					   'action' => 'listOrgCurrentBudgetWithdrawal',
					   ),
				),
			),
			...
			'capitalbudgetwithdrawal' => array(
			 ...
			 'listorgcapitalbudgetwithdrawal' => array(
				'type' => 'segment',
				'options' => array(
				   'route' => '/listorgcapitalbudgetwithdrawal[/:action][/:id]',
				   'constraints' => array(
					   'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					   'id' => '[a-zA-Z0-9_-]*',
					   ),
				   'defaults' => array(
					   'controller' => 'BudgetTransactions',
					   'action' => 'listOrgCapitalBudgetWithdrawal',
					   ),
				),
			),
			...
			'insertcapitalbudgetwithdrawal' => array(
			 ...
			 'updatewithdrawalbudgetproposal' => array(
				'type' => 'segment',
				'options' => array(
				   'route' => '/updatewithdrawalbudgetproposal[/:action][/:id][/:status][/:type]',
				   'constraints' => array(
					   'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					   'id' => '[a-zA-Z0-9_-]*',
					   'status' => '[a-zA-Z0-9_-]*',
				   ...
				   'defaults' => array(
					   'controller' => 'BudgetTransactions',
					   'action' => 'updateWithdrawalBudgetProposal',
					   ),
				),
			),
      	),
