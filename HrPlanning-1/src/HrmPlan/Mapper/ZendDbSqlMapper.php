...
class ZendDbSqlMapper implements HrmPlanMapperInterface
{
	...
	*/
	...
	public function find($id)
	{
		...
		$select = $sql->select('hr_management');
	...
	*/
	...
	public function saveDetails(HrmPlan $hrmPlanObject, $data)
	{
		...
		$emp_position_title = $this->getAjaxDataId($tableName = 'position_title', $data['position_title_id']);
		$emp_position_level = $this->getAjaxDataId($tableName = 'position_level', $data['position_level_id']);
		$emp_position_category = $this->getAjaxDataId($tableName = 'position_category', $data['position_category_id']);
