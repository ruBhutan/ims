...
class ExaminationsController extends AbstractActionController
{
	...
	*/
	...
	public function declarePreviousResultAction()
	{
		$this->loginDetails();
		$message = NULL;
		...
		$this->examinationService->declareSemesterPreviousResults($organisation_id);
		$this->flashMessenger()->addMessage('The Result has been declared successfully for previous Academic Years');
		return $this->redirect()->toRoute('declareresults');
