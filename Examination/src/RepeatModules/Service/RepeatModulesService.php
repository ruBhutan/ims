...
class RepeatModulesService implements RepeatModulesServiceInterface
{
	...
	*/
	...
	{
		return $this->repeatModulesMapper->listRegisteredRepeatModules($student_id, $organisation_id, $type);
	}
	...
	{
		return $this->repeatModulesMapper->getModuleRepeatRegistrationDuration($organisation_id);
	}

	public function listEligibleRepeatModuleList($student_id)
	{
		return $this->repeatModulesMapper->listEligibleRepeatModuleList($student_id);
	}
