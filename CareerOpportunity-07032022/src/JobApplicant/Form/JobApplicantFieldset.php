...
class JobApplicantFieldset extends Fieldset implements InputFilterProviderInterface
{
	...
	public function __construct()
     {
		...
		$this->setObject(new JobApplicant());
		 ...
		 $this->add(array(
		  ...
		  $this->add(array(
           'name' => 'education_qualification_experience',
            'type'=> 'textarea',
             'options' => array(
                 'class'=>'control-label',
             ),
