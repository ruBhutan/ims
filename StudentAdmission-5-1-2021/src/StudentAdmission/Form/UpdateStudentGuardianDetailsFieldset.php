...
class UpdateStudentGuardianDetailsFieldset extends Fieldset implements InputFilterProviderInterface
{
	public function __construct()
     {
         // we want to ignore the name passed
        parent::__construct('updatestudentguardiandetails');
		
		$this->setHydrator(new ClassMethods(false));
		$this->setObject(new UpdateStudentGuardianDetails());
