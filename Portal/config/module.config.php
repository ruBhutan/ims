...
return array(
	...
	'router' => array(
 		'routes' => array(
 			...
 			'deletestaffpendingtour' => array(
 				'type' => 'segment',
 				'options' => array(
 				'route' => '/deletestaffpendingtour[/:action][/:id]',
 				'constraints' => array(
 					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
 					'id' => '[a-zA-Z0-9_-]*',
 					),
 			...
 			'printapprovedtraveldetails' => array(
 				'type' => 'segment',
 				'options' => array(
 				'route' => '/printapprovedtraveldetails[/:action][/:id][/:type]',
 				'constraints' => array(
 					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
 					'id' => '[a-zA-Z0-9_-]*',
					'type' => '[a-zA-Z0-9_-]*',
 			...
 			'individualassessmentdetail' => array(
				'type' => 'segment',
				'options' => array(
				'route' => '/individualassessmentdetail[/:action][/:id]',
				'constraints' => array(
					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					'id' => '[a-zA-Z0-9_-]*',
					),
			   'defaults' => array(
				   'controller' => 'StaffPortal',
				   'action' => 'individualAssessmentDetail',
					),
				),
			),
			 ...
			 'printstudentdetailscard' => array(
				'type' => 'segment',
				'options' => array(
				'route' => '/printstudentdetailscard[/:action][/:id]',
				'constraints' => array(
					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					'id' => '[a-zA-Z0-9_-]*',
					),
			   'defaults' => array(
				   'controller' => 'StudentPortal',
				   'action' => 'printStudentDetailsCard',
					),
				),
			),
 			...
 			'studentcurrentsemesterdetails' => array(
 				'type' => 'segment',
 				'options' => array(
 				'route' => '/studentcurrentsemesterdetails[/:action][/:id]',
 				'constraints' => array(
 					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
 					'id' => '[a-zA-Z0-9_-]*',
 					),
				'defaults' => array(
					'controller' => 'StudentPortal',
					'action' => 'studentCurrentSemesterDetails',
 					),
 				),
 			),

 			'stdcurrentsemestercadetails' => array(
 				'type' => 'segment',
 				'options' => array(
 				'route' => '/stdcurrentsemestercadetails[/:action][/:id]',
 				'constraints' => array(
 					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
 					'id' => '[a-zA-Z0-9_-]*',
 					),
				'defaults' => array(
					'controller' => 'StudentPortal',
					'action' => 'stdCurrentSemesterCaDetails',
 					),
 				),
			 ),


			 'individualstdmodulecadetails' => array(
				'type' => 'segment',
				'options' => array(
				'route' => '/individualstdmodulecadetails[/:action][/:id]',
				'constraints' => array(
					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					'id' => '[a-zA-Z0-9_-]*',
					),
			   'defaults' => array(
				   'controller' => 'StudentPortal',
				   'action' => 'individualStdModuleCaDetails',
					),
				),
			),
			 
			 'individualstdmoduleabsentdetails' => array(
				'type' => 'segment',
				'options' => array(
				'route' => '/individualstdmoduleabsentdetails[/:action][/:id]',
				'constraints' => array(
					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					'id' => '[a-zA-Z0-9_-]*',
					),
			   'defaults' => array(
				   'controller' => 'StudentPortal',
				   'action' => 'individualStdModuleAbsentDetails',
					),
				),
			),

			'viewindividualdeclaredresult' => array(
				'type' => 'segment',
				'options' => array(
				'route' => '/viewindividualdeclaredresult[/:action][/:id]',
				'constraints' => array(
					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					'id' => '[a-zA-Z0-9_-]*',
					),
			   'defaults' => array(
				   'controller' => 'StudentPortal',
				   'action' => 'viewIndividualDeclaredResult',
					),
				),
			),
