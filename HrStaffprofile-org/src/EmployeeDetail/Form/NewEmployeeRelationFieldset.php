...
class NewEmployeeRelationFieldset extends Fieldset implements InputFilterProviderInterface
{
         ...
         $this->add(array(
			   ...
			   'options' => array(
					...
					'target_element' => array(
						'type' => 'EmployeeDetail\Form\NewRelationDetailsFieldset',
					),
			   ),
		 ));
