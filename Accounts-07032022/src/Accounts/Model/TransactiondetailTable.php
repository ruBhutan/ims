   ...
   /**
	...
	{		
		...
		$sub0 = new Select("accounts_closing_balance");
			...
			$total_debit = $this->getSumbySubheadforBA($ending_date, 'debit', $subhead_id);
			$total_credit = $this->getSumbySubheadforBA($ending_date, 'credit', $subhead_id); 			 
	 ...
	 * @return Int
	 */
	public function getOpeningBalanceforCA($end_date, $subhead_id)
	{		
		...
		$sub0 = new Select("accounts_closing_balance");
			...
			$total_debit = $this->getSumbySubheadforCA($ending_date, 'debit', $subhead_id);
			$total_credit = $this->getSumbySubheadforCA($ending_date, 'credit', $subhead_id); 			 
	 ...
	 * @return int
	 */		
	public function getSumbySubheadforCA($start_date, $column, $sub_head)
	{		
		$sub0 = new Select("accounts_transaction");
		$sub0->columns(array("id"))
			 ->where(array("status" => "3")) //committed status
