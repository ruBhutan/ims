...
interface ProgrammeServiceInterface
{
	 ...
	 *
	 * @return array|ProgrammeInterface[]
	*/
	...
	*/
	...
	/**
	 * @param ProgrammeInterface $programmeObject
	 *
	 * @param ProgrammeInterface $programmeObject
	 * @return ProgrammeInterface
	 * @throws \Exception
	...
	*/
	...
	public function getCompiledMarks($assessment_component_id, $section, $type);
	...
	*/
	...
	public function getAssessmentComponentNumber($programmes_id, $semester);
