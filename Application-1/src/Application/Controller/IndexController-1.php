...
class IndexController extends AbstractActionController
{
    ...
    { 
        ...
        $leave_notifications = $this->applicationService->getNotifications('Leave Application', $this->userrole, $this->employee_details_id, $this->user_department, $this->organisation_id);
		...
		$goods_requisition_notifications = $this->applicationService->getNotifications('Goods Requisition', $this->userrole, $this->employee_details_id, $this->user_department, $this->organisation_id);
		$goods_requisition_notifications = $this->applicationService->getNotifications('Goods Requisition', $this->userrole, $this->employee_details_id, $this->user_department, $this->organisation_id);
