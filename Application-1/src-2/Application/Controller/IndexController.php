...
class IndexController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        $leave_notifications = $this->applicationService->getNotifications('Leave Application', $this->userrole, $this->employee_details_id);
		$pms_notifications = $this->applicationService->getNotifications('PMS', $this->userrole, $this->employee_details_id);
		$tour_notifications = $this->applicationService->getNotifications('Tour', $this->userrole, $this->employee_details_id);
		$goods_requisition_notifications = $this->applicationService->getNotifications('Goods Requisition', $this->userrole, $this->employee_details_id);
		$goods_requisition_notifications = $this->applicationService->getNotifications('Goods Requisition', $this->userrole, $this->employee_details_id);
