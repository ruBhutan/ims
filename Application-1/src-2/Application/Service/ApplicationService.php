...
class ApplicationService implements ApplicationServiceInterface
{
	...
	*/
	...
	{
		return $this->applicationMapper->getNotifications($notification_type, $userrole, $employee_details_id);
	}
	...
	{
		return $this->applicationMapper->getStaffDetails($employee_details_id);
	}
