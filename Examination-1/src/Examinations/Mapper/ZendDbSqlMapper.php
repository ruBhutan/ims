	...
	*/
	...
	public function getExaminationTimetable($data, $employee_id, $organisation_id)
	{
		...
		$select->from(array('t1' => 'examination_timetable')) 
				...
				->where(array('t1.organisation_id' =>$organisation_id, 't4.academic_session' => $semester, 't4.academic_year' => $academic_year, 't1.programmes_id' => $programme_id, 't4.year' => $year));
