...
class ZendDbSqlMapper implements GoodsDepreciationMapperInterface
{
	...
	*/
	...
	$select-> //from (array('egoods' => 'emp_goods')) 
		//	->join(array('emp1' => 'employee_details'),
		//	   'egoods.employee_details_id = emp1.id', array('first_name'))
			from(array('t1' => 'item_name')) //,
			//	't1.id = egoods.goods_received_id') //base table
