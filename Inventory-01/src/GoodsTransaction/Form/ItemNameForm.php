...
class ItemNameForm extends Form
 {
    protected $serviceLocator;
     ...
     public function __construct($serviceLocator = null, array $options = [])
     {
        ...
        $this->add(array(
             'type' => 'GoodsTransaction\Form\ItemNameFieldset',
             'options' => array(
         ...
         $this->add(array(
            'name' => 'major_class_id',
             'type'=> 'Select',
              ...
              'attributes' => array(
                   'class' => 'form-control ',
                   'id' => 'selectItemDetailsMajorClass',
        ...
        $this->add(array(
           'name' => 'item_sub_category_id',
            'type'=> 'Select',
             ...
             'attributes' => array(
                  'class' => 'form-control ',
                  'id' => 'selectItemDetailsSubCategory',
                  'options' => array(),
                  'required' => 'required',
             ),
         ));
    ...
    /* private function createItemCategoryType()
    {
        // You probably want to get those from the Database as in previous example
        $dbAdapter = $this->serviceLocator->get('Zend\Db\Adapter\Adapter');
