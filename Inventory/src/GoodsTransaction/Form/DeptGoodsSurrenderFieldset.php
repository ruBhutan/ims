...
class DeptGoodsSurrenderFieldset extends Fieldset implements InputFilterProviderInterface
{
	public function __construct()
     {
         // we want to ignore the name passed
        parent::__construct('deptgoodssurrender');
		
		$this->setHydrator(new ClassMethods(false));
		$this->setObject(new DeptGoodsSurrender());
