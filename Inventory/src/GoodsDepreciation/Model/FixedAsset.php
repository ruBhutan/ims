...
class FixedAsset
{
	//ItemCategory, ItemSubCategory, ItemQuantityType and ItemName and Goods_received, employee_details 
	protected $id;
	...
	protected $item_received_date; // its from goods received

	protected $employee_details_id;  // From employee goods table - check to whom item has been issued
