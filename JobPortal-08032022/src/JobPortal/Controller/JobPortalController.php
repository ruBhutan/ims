...
class JobPortalController extends AbstractActionController
{
	...
	public function deleteRegistrantEmploymentDetailsAction()
	{
		$this->loginDetails();
       ...
       //var_dump($id); die();
        ...
        try {
			 $this->jobService->deleteEmploymentDetails($id);
			 $this->auditTrailService->saveAuditTrail('UPDATE', 'Job Applicant Employment Details', 'ALL', 'SUCCESS');
			 $this->flashMessenger()->addMessage('Successfully deleted your employment details');
