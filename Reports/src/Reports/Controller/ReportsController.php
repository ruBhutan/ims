...
class ReportsController extends AbstractActionController
{
	...
	{ 
		...
		$report_list = array(
				...
				'staff_cancelled_leave' => 'Staff Cancelled Leave',
	...
	public function hrLifeCycleReportsAction()
	{
		...
		$report_list = array(
			...
			//	'staff_by_bloodgroup' => 'Staff By Blood Group',
				'overall' => 'Over all statistics',
				'emptypestats' => 'Statistics by Employee Type',
			);
		...
		return new ViewModel(array(
			...
			'occupationalGroup' => $occupationalGroup,
			'report_details' => $report_details,
			'gender' => $this->reportService->getGender(),
			'emp_type' => $this->reportService->getEmptype(),
			));
