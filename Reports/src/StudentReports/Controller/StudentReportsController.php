...
class StudentReportsController extends AbstractActionController
{
	...
	public function overallStudentReportsAction()
	{
		...
		$report_list = array(
				...
				'student_by_overall' => 'Overall statistics',
			);
	...
	/* 
		return new ViewModel(array(
		 ...
		 return new ViewModel(array(
                        ...
                        'report_details' => $report_details,
                        'enrollment_year' => $enrollment_year,
                        'programmes' => $this->studentreportsService->getProgrammes(),
                        'gender' => $this->studentreportsService->getGender(),
                        'scholarships' => $this->studentreportsService->getScholarships(),
                        'maxyear'   => $this -> studentreportsService->getMaxDuration(),
		)); 
	}
