...
class StudentReportsService implements StudentReportsServiceInterface
{
	...
	*/
	...
	public function getProgrammes()
        {
                return $this->studentreportMapper->getProgrammes();
        }
        public function getGender()
        {
                return $this->studentreportMapper->getGender();
        }
        public function getScholarships()
        {
                return $this->studentreportMapper->getScholarships();
        }

        public function getMaxDuration()
        {

                return $this->studentreportMapper->getMaxDuration();
