...
class ZendDbSqlMapper implements ChequeManagementMapperInterface
{
	/**
	...
	*/
	...
	/*
	 * @var \ChequeManagement\Model\ChequeManagementInterface
	*/
	...
	*/
	...
	public function findCalendarDetail($id)
	{
		$sql = new Sql($this->dbAdapter);
		$select = $sql->select();
		$select->from(array('t1' => 'academic_cheque'));
	...
	public function saveChequeManagement(ChequeManagement $academicObject)
	{
