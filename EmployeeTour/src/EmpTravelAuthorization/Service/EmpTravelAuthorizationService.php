...
class EmpTravelAuthorizationService implements EmpTravelAuthorizationServiceInterface
{
	...
	*/
	...
	{
		return $this->empTravelAuthorizationMapper->fetchPaymentTypes();
	}
  
  public function saveTravelPaymentDetails(TravelPaymentDetails $travelPaymentDetails)
	{
		return $this->empTravelAuthorizationMapper->saveTravelPaymentDetails($travelPaymentDetails);
	}
  
  public function fetchTravelPaymentList($field, $id)
	{
		return $this->empTravelAuthorizationMapper->fetchTravelPaymentList($field, $id);
	}
  
  public function updateTravelAuthorizationStatus($id)
	{
		return $this->empTravelAuthorizationMapper->updateTravelAuthorizationStatus($id);
	}
	
  public function deletePaymentDetails($id)
	{
		return $this->empTravelAuthorizationMapper->deletePaymentDetails($id);
	}
