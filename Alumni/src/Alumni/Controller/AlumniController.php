   ...
   'approvals' => $approvals,
    ...
    public function alumniMemberListAction()
    {
        ...
        if($request->isPost()){
            ...
            if($form->isValid()){ 
                try{
                    $alumni_programme = $this->getRequest()->getPost('alumni_programme');
                    $alumni_batch = $this->getRequest()->getPost('alumni_batch');
                    $alumni_name = $this->getRequest()->getPost('alumni_name');
                    $alumniMemberList = $this->alumniService->getAlumniMemberList($alumni_programme, $alumni_batch, $alumni_name, $this->organisation_id);
     ...
     public function alumniProfileAction()
     {
        ...
        if(is_numeric($id)){
                return new ViewModel(array(
                    ...
                    'alumniPersonalDetails' => $this->alumniService->getAlumniPersonalDetails($id),
					'alumniPermanentAddress' => $this->alumniService->getAlumniPermanentAddress($id),
					'alumniContactDetails' => $this->alumniService->getAlumniContactDetails($id),
					'alumniEmploymentDetails' => $this->alumniService->getAlumniEmploymentDetails($id),
					'id' => $id,
                    'organisation_id' => $this->organisation_id,
            ));
        }else{
            return new ViewModel(array(
                    'details' => $this->alumniService->findAlumniProfile($this->alumni_id),
                    'alumniPersonalDetails' => $this->alumniService->getAlumniPersonalDetails($this->alumni_id),
					'alumniPermanentAddress' => $this->alumniService->getAlumniPermanentAddress($this->alumni_id),
					'alumniContactDetails' => $this->alumniService->getAlumniContactDetails($this->alumni_id),
					'alumniEmploymentDetails' => $this->alumniService->getAlumniEmploymentDetails($this->alumni_id),
