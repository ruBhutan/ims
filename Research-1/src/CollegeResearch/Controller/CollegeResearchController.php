...
class CollegeResearchController extends AbstractActionController
{
	...
	public function applyCollegeGrantAction()
	{
		...
		$grantList = $this->collegeResearchService->getResearchGrantList();
		$grantAnnouncement = $this->collegeResearchService->getResearchGrantAnnouncement($tmp_id = 'College Grant');
	...
	*/
	...
	public function updateCollegeGrantAction()
	{
		...
		$form = new SearchForm();
		$researches = $this->collegeResearchService->getCargList(NULL, NULL, NULL, 'Approved', $this->organisation_id);
