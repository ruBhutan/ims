...
class EmpResignationService implements EmpResignationServiceInterface
{
	...
	*/
	...
	{
		return $this->resignationMapper->getResignationType($resignationType);
	}

	public function getSupervisorEmailId($userrole, $departments_units_id)
	{
		return $this->resignationMapper->getSupervisorEmailId($userrole, $departments_units_id);
	}


	public function getRecordedResignedEmpDetails($employee_details_id, $organisation_id)
	{
		return $this->resignationMapper->getRecordedResignedEmpDetails($employee_details_id, $organisation_id);
	}


	public function getIssuingAuthorityEmails($staff_role, $organisation_id, $departments_units)
	{
		return $this->resignationMapper->getIssuingAuthorityEmails($staff_role, $organisation_id, $departments_units);
	}
