...
return array(
	...
	'router' => array(
 		'routes' => array(
			...
			'selffinancedstudentlists' => array(
				'type' => 'segment',
				'options' => array(
		 		'route' => '/selffinancedstudentlists[/:action][/:id]',
		 		'constraints' => array(
					'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
					'id' => '[a-zA-Z0-9_-]*',
		 			),
				'defaults' => array(
					'controller' => 'StudentAdmission',
					'action' => 'selfFinancedStudentLists',
					),
				),
			),
	 
			'addstudentfees' => array(
						'type' => 'segment',
						'options' => array(
				'route' => '/addstudentfees[/:action][/:id]',
				'constraints' => array(
				'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
				'id' => '[a-zA-Z0-9_-]*',
				),
				'defaults' => array(
				'controller' => 'StudentAdmission',
				'action' => 'addStudentFees',
				),
						),
					),
			
			'bulkgeneratefees' => array(
				'type' => 'Segment',
				'options' => array(
					'route' => '/bulkgeneratefees[/:action][/:id]',
					'constraints' => array(
						'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
						'id' => '[a-zA-Z0-9_-]*',
					),
