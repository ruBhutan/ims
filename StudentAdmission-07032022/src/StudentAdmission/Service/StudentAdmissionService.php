...
class StudentAdmissionService implements StudentAdmissionServiceInterface
{
	...
	*/
	...
	{
		return $this->studentAdmissionMapper->getSemester($organisation_id);
	}
	
	public function getCurrentAcademicYear($academic_event_details)
	{
		return $this->studentAdmissionMapper->getCurrentAcademicYear($academic_event_details);
	}

	public function getSelfFinancedStudentLists($stdName, $stdId, $organisation_id)
	{
		return $this->studentAdmissionMapper->getSelfFinancedStudentLists($stdName, $stdId, $organisation_id);
	}
	
  	public function getSelfFinancedStudentListsToAdmin($stdName, $stdId,$organisation_id)
	{
		return $this->studentAdmissionMapper->getSelfFinancedStudentListsToAdmin($stdName, $stdId,$organisation_id);
	}

	public function fetchFeeCategories($organisation_id)
	{
		return $this->studentAdmissionMapper->fetchFeeCategories($organisation_id);
	}
  
  public function saveStudentFeeDetails(StudentFeeDetails $studentFeeDetails)
	{
		return $this->studentAdmissionMapper->saveStudentFeeDetails($studentFeeDetails);
	}
  
  public function listStudentFeeList($student_id, $id = null)
	{
		return $this->studentAdmissionMapper->listStudentFeeList($student_id, $id);
	}
  
  public function fetchStudentSemesterList($semester_id = null)
	{
		return $this->studentAdmissionMapper->fetchStudentSemesterList($semester_id);
	}
  
  public function isStudentFeesPaid($data, $id = null)
	{
		return $this->studentAdmissionMapper->isStudentFeesPaid($data, $id);
	}
  
  public function fetchStudentFeeDetails($id)
	{
		return $this->studentAdmissionMapper->fetchStudentFeeDetails($id);
	}
  
  public function fetchStudentFeePaymentDetails($field, $id)
	{
		return $this->studentAdmissionMapper->fetchStudentFeePaymentDetails($field, $id);
	}
  
  public function fetchStudentFeeStructureDetails($id)
	{
		return $this->studentAdmissionMapper->fetchStudentFeeStructureDetails($id);
	}
  
  public function fetchPaymentTypes()
	{
		return $this->studentAdmissionMapper->fetchPaymentTypes();
	}
  
  public function getStudentFeeStructureDetails($organisation_id)
	{
		return $this->studentAdmissionMapper->getStudentFeeStructureDetails($organisation_id);
	}
  
  public function saveStudentFeePaymentDetails(StudentFeePaymentDetails $studentFeePaymentDetails)
	{
		return $this->studentAdmissionMapper->saveStudentFeePaymentDetails($studentFeePaymentDetails);
	}
  
  public function updateStudentFeeDetailsStatus($id, $status = 'Completed')
	{
		return $this->studentAdmissionMapper->updateStudentFeeDetailsStatus($id, $status);
	}
  
  public function deleteStudentFeeDetails($id)
	{
		return $this->studentAdmissionMapper->deleteStudentFeeDetails($id);
	}
  
  public function deleteStudentFeePaymentDetails($id)
	{
		return $this->studentAdmissionMapper->deleteStudentFeePaymentDetails($id);
  }
  
  public function generateBulkStudentFees($organisation_id, $student_fee_structure_id, $due_date)
	{
		return $this->studentAdmissionMapper->generateBulkStudentFees($organisation_id, $student_fee_structure_id, $due_date);
	}
  public function checkChequeAndDraftNumExists($data,$num) {
    return $this->studentAdmissionMapper->checkChequeAndDraftNumExists($data,$num);
  }
}