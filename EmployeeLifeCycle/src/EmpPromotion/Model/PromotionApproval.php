...
{
	protected $id;
	protected $promotion_order_type;
	...
	public function getPromotion_Order_Type()
	{
		return $this->promotion_order_type;
	}
	
	public function setPromotion_Order_Type($promotion_order_type)
	{
		$this->promotion_order_type = $promotion_order_type;
	}
	...
	public function setPromotion_Status()
	{
		return $this->promotion_status;
	}
	
	public function getPromotion_Status($promotion_status)
	{
