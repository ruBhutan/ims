...
class ZendDbSqlMapper implements AdministrationMapperInterface
{
	...
	*/
	...
	public function writeSideNavigationContents($menu_level_0, $menu_level_1, $menu_level_2, $menu_level_3)
	{
		...
		$side_navigation .= '<h3><?php $userRole=$this->layout()->userRole; echo $userRole; $userRegion=$this->layout()->userRegion; echo ", $userRegion"; ?></h3>'.PHP_EOL;
	...
	/*
	* To create directory if not exist, if exist then open and look for php file, if exis then it will open and write. If not create php file, open and write inside phtml file.
	*/
