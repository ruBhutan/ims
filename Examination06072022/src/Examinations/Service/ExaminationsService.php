...
class ExaminationsService implements ExaminationsServiceInterface
{
	...
	*/
	...
	{
		return $this->examinationMapper->getExaminationDates($organisation_id, $data);
	}

	public function getExaminationTiming($organisation_id, $data)
	{
		return $this->examinationMapper->getExaminationTiming($organisation_id, $data);
	}
	...
	{
		return $this->examinationMapper->declareSemesterPreviousResults($organisation_id);
	}
