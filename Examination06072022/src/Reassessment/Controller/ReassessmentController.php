...
class ReassessmentController extends AbstractActionController
{
	...
	public function applyReassessmentAction()
	{
		...
		$total_module_list = $this->reassessmentService->getTotalModuleList($this->student_id);

		$duration = $this->reassessmentService->getReassessmentAnnouncementPeriod($this->organisation_id);
		...
		return new ViewModel(array(
			...
			'total_module_list' => $total_module_list,
